...
// //         navigate(`${import.meta.env.BASE_URL}firebase/login`);  // ✅ Uses BASE_URL
// // };

// const handleLogout = () => {
//     // Navigate first to ensure route change happens before session clear
//     navigate(`${import.meta.env.BASE_URL}firebase/login`, { replace: true });
//     // Clear session after navigation is initiated
...
//                                 </div>
//                                 <div>
//                                     <Link className='dropdown-item' to="#"><i className="fa fa-user me-1"></i> My Profile
//                                     </Link>
...
//                                     </Link>
//                                     <Link className='dropdown-item' to="#" onClick={handleLogout}>  <i className="fa fa-sign-out-alt me-1"></i> Sign Out
//                                     </Link>
//                                 </div>
//                             </Dropdown.Menu>
//                         </Dropdown>
